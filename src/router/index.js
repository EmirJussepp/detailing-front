...
import MovimientosCajaHistoricoView from "../views/MovimientosCajaHistoricoView.vue"
...

  {
    ...
    children: [
...

      {
        ...
        name: "caja.dashboard",
        component: CajaView,
        meta: { requiresAuth: true, perm: "caja:ver" },
      },
...

      {
        ...
        component: MovimientosCajaHistoricoView,
        meta: { requiresAuth: true, perm: "movimientos_caja:ver" },
      },
